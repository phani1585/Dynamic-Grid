var productList = [
  ...
  createHeading("Clothing for Men and Women");

  const sectionContainer = document.createElement('div');
  sectionContainer.classList.add("section-container");
  mainWrapper.appendChild(sectionContainer);

  createHeading("Accessories for Men and Women");

  const accSectionContainer = document.createElement('div');
  accSectionContainer.classList.add("section-container");
  mainWrapper.appendChild(accSectionContainer);

  function createHeading(heading){
    const sectionHeading = document.createElement('h2');
    sectionHeading.innerHTML = heading;
    sectionHeading.classList.add("section-heading");
    mainWrapper.appendChild(sectionHeading);
  }

  var clothCardCreation = function(i,section){
    ...
    cardContainer.appendChild(detailsBox)

    const titleOfproduct = document.createElement('h3')
    titleOfproduct.classList.add("title-of-product")
    titleOfproduct.innerHTML = productList[i].name
    detailsBox.appendChild(titleOfproduct)

    const brand = document.createElement('h4')
    brand.classList.add("brand-of-product")
    brand.innerHTML = productList[i].brand
    detailsBox.appendChild(brand)

    const price = document.createElement('h5')
    price.classList.add("brand-of-product")
...
//Clothing Section
  for(let i = 0 ; i<productList.length; i++){
    ...
    if(productList[i].isAccessory === false){
      clothCardCreation(i,sectionContainer);
    }
  }
...
//Accessories Section
  for(let i = 0 ; i<productList.length; i++){
    ...
    if(productList[i].isAccessory === true){
      clothCardCreation(i,accSectionContainer);
    }
  }
